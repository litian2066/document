...
3. 然后再根据协议构造URL，其实就是把map里面的配置加到URL上面，比如`registry://127.0.0.1:2181/org.apache.dubbo.registry.RegistryService?&registryKey=zookeeper& application=democonsumer&dubbo=2.0.2&interface=org.apache.dubbo.registry.RegistryService&pid=1214&qos.port=33333×tamp=1545721981946`
